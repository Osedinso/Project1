...
def singleBook(isbn):
    ...
    apiCall = requests.get("https://www.goodreads.com/book/review_counts.json", params={"key": "x80noZgDU3grXWl0FYTgw", "isbns": isbn })
...
def api(isbn):
    if 'email' in session: 
        ...
        res = requests.get("https://www.goodreads.com/book/review_counts.json", params={"key": "x80noZgDU3grXWl0FYTgw", "isbns": isbn})
